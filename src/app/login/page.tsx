        ...
        if (weddingToClaim) {
          try {
            ...
            if (storedWeddings[weddingToClaim]) {
              ...
              // Add to user's wedding sites list if not already there
              if (!user.weddingSites) {
                user.weddingSites = [];
              }
              
              if (!user.weddingSites.includes(weddingToClaim)) {
                user.weddingSites.push(weddingToClaim);
                users[email] = user;
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="text-center">
                <p className="text-xs text-gray-500 mb-4">Have a Wedding ID?</p>
                <Link
                  href="/wedding-login"
                  className="text-sm text-emerald-600 hover:text-emerald-700 font-medium"
                >
                  Access Your Wedding Site
                </Link>
              </div>
            </div>
          </div>
